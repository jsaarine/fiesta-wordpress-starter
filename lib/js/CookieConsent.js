...
(function () {
	...
	var n = cookieConsent = function(props) {
		...
		<div class="inner">
			...
			<button class="c-button">${consentButtonText}</button>
		...
		el.querySelector(".c-button").addEventListener("click", function(e) {
		...
		if(settings) {
				...
				<div class="inner">
					...
					<div class="select">
						<label class="c-checkbox">
							...
							<span><span></span>${settings.cookieTypes.required}</span>
						</label>
						<label class="c-checkbox">
							<input type="checkbox" value="1">
							<span><span></span>${settings.cookieTypes.analytics}</span>
						</label>
						<label class="c-checkbox">
							<input type="checkbox" value="2">
							<span><span></span>${settings.cookieTypes.marketing}</span>
						</label>
					</div>
			...
			n.overlay = new Overlay(n.overlayElement.querySelector(".c-overlay"));
	...
	n.appendScripts = function(scripts) {
		if(scripts) {
			scripts.forEach(function(item) {
				...
				var scriptSrc = document.createTextNode(item);
